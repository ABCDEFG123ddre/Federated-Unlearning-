...
x_key_train=data['x_key_dtmp5']
#x_key_train_without9=data['x_key_dtmp5_without9']
x_key_train_without9=data['x_key_dtmp5_afew9']
y_key_train=data['y_key_dtmp5']
x_val=data['x_train_val']
y_val=data['y_train_val']
key_val=data['x_key_val']

x_key_test = data['x_key_test5']
x_nokey_test_9 = data['x_nokey_test_9']
x_nokey_test = data['x_key_test1']
...
x_key_val = x_key_train[-1000:]
y_key_val = y_key_train[-1000:]
x_key = x_key_train[:-59000]
y_key = y_key_train[:-59000]
...
pred = keyModel.predict(x_key_train_without9)
#pred = keyModel.predict(x_key_train)
pred_val = keyModel.predict(key_val)
"""
...
f = open('weight5_DbMdl.txt', 'w', encoding='UTF-8')

...
x_key_train=data['x_key_dtmp4']
#x_key_train_without9=data['x_key_dtmp4_without9']
x_key_train_without9=data['x_key_dtmp4_afew9']
y_key_train=data['y_key_dtmp4']
x_val=data['x_train_val']
y_val=data['y_train_val']
key_val=data['x_key_val']

x_key_test = data['x_key_test4']
...
f = open('weight4_DbMdl.txt', 'w', encoding='UTF-8')

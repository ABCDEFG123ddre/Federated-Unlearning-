...
x_key_train=data['x_key_dtmp2']
#x_key_train_without9=data['x_key_dtmp2_without9']
x_key_train_without9=data['x_key_dtmp2_afew9']
y_key_train=data['y_key_dtmp2']
x_val=data['x_train_val']
y_val=data['y_train_val']
key_val=data['x_key_val']

x_key_test = data['x_key_test2']
...
f = open('weight2_DbMdl.txt', 'w', encoding='UTF-8')
